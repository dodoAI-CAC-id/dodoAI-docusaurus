...
* フロントエンドの開発は、必ず以下のディレクトリ内の各種ドキュメントに記載のガイドを参考にすること
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/dodoai-agentic-dev-framework-develop/docs/docs/frontend/design
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/dodoai-agentic-dev-framework-develop/docs/docs/frontend/develop
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/dodoai-agentic-dev-framework-develop/docs/docs/frontend/modular-onion-architecture
* 以下の画面設計書に基づき、フロントエンド画面を構築すること
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/docusaurus/docs/frontend/screen-design/history-screen.md
* 上記の画面設計書上で記載されているAPIと疎通するインターフェースも実装すること。各種APIの定義は以下に記載されている
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/docusaurus/static/swagger/v2/microservice.yaml
* 画面のUIは、以下の画像にあるデザインを実現すること
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/docusaurus/static/img/docs/frontend/history-screen.png
...
* フロントエンドアプリケーションは、以下のディレクトリ内で開発すること
    - /Users/daikiichikawa/Documents/source/dodoAI-docusaurus/src/frontend
